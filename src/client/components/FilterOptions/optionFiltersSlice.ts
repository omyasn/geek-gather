...
export const selectOptionsFilter =
  (name: optionsFN) => (state: RootStateType) =>
    state.optionFilters[name];
export const selectOptionFilters = (state: RootStateType) =>
  state.optionFilters;
export const { addOption, removeOption, clearAllOptions } =
  optionFiltersSlice.actions;

export const addOptionWithHistory =
  ({
    name,
    value,
  }: OptionFilterPayload): ThunkAction<
    void,
    RootStateType,
    BrowserHistory,
    AnyAction
...
export const removeOptionWithHistory =
  ({
    name,
    value,
  }: OptionFilterPayload): ThunkAction<
...
export const clearAllOptionsWithHistory =
  (): ThunkAction<void, RootStateType, BrowserHistory, AnyAction> =>
  (dispatch, getState, history) => {
